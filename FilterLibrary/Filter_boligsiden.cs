...
{
    public class Filter_boligsiden : AbstractFilter
    {
        ...
        public Filter_boligsiden(NLog.Logger logger, string postcode)
        {
            _logger = logger;
            var url = "https://www.boligsiden.dk/" + postcode;   /// Need to do something with the Postcode!!!
            _doc = _web.Load(url);
        }
