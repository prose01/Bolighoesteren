...
{
    public class Filter_estate : AbstractFilter
    {
        ...
        public Filter_estate(NLog.Logger logger, string postcode)
        {
            _logger = logger;
            var url = "https://www.estate.dk/soegeresultat-boliger?isRental=false&postalCodes=" + postcode;
            _doc = _web.Load(url);
        }
